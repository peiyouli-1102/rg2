...
#define SRVO11 557		//557
#define SRVO12 290
#define SRVO13 500		//500

#define SRVO21 360		//360
#define SRVO22 570
#define SRVO23 380

#define SRVO31 265			//265
#define SRVO32 740			//740
#define SRVO33 1175			//1175
#define SRVO301 120		//490-265
#define SRVO302 100		//225 * 2/3

#define SRVO41 580			//580
#define SRVO42 790
...
void _5get(void){
	uint32_t t;
	uint32_t pul1time = (get_stat == 1 )?10000:2800, puttime = 1000, movetime = 500, staytime = 1000, adds = 1000;
	...
	if( t < staytime ){
		...
		_5srvo(SRVO12, SRVO22, dart, SRVO41);
		_5othr( 0, 1 );
	}else if( t < 4* staytime + movetime + 3* pul1time + adds){
		_5srvo(SRVO12, SRVO22, dart, SRVO41);
		_5othr( 2, 1 );
	}else if( t < 5* staytime + movetime + 3* pul1time + adds){
		_5srvo(SRVO12, SRVO22, dart, SRVO41);
		_5othr( 0, 1 );
	}else if( t < 5* staytime + 2* movetime + 3* pul1time + adds){
		_5move(SRVO12, SRVO22, dart, SRVO41, SRVO13, SRVO23, dart, SRVO41, t-(5* staytime + movetime + 3* pul1time + adds));
		_5othr( 0, 1 );
	}else if( t < 6* staytime + 2* movetime + 3* pul1time + adds){
		_5srvo(SRVO11, SRVO21, dart, SRVO41);
		_5othr( 0, 1 );
		if(get_stat == 1){
	...
	}else if( t < 6* staytime + 3* movetime + 3* pul1time + adds){
		_5move(SRVO13, SRVO23, dart, SRVO41, SRVO11, SRVO21, dart, SRVO41, t-(6* staytime + 2* movetime + 3* pul1time + adds));
		_5othr( 0, 1 );
	}else if( t < 7* staytime + 3* movetime + 3* pul1time + adds){
		_5srvo(SRVO11, SRVO21 + shk, dart, SRVO41);
		_5othr( 1, 1 );
		Time.tasks[4] = (struct Task){_4stp, "stop", 1, Time.ms};
		clean_pid();
		result = 0 ;
	}else if( t < 7* staytime + 3* movetime + 3* pul1time + puttime + adds){
		_5srvo(SRVO11, SRVO21 + shk, dart, SRVO41);
		_5othr( 1, 1 );
	}else if( t < 8* staytime + 3* movetime + 3* pul1time + puttime + adds){
		_5srvo(SRVO11, SRVO21, dart, SRVO41);
		_5othr( 0, 1 );
	}else if( t < 8* staytime + 4* movetime + 3* pul1time + puttime + adds){
		_5move(SRVO11, SRVO21, dart, SRVO41, SRVO11, SRVO21, dart + SRVO301, SRVO41, t-(8* staytime + 3* movetime + 3* pul1time + puttime + adds));
		_5othr( 0, 1 );
	}else if( t < 9* staytime + 4* movetime + 3* pul1time + puttime + adds){
		_5srvo(SRVO11, SRVO21, dart + SRVO301, SRVO41);
		_5othr( 0, 2 );
	}else if( t < 9* staytime + 4* movetime + 3* pul1time + 3* puttime + adds){
		_5srvo(SRVO11, SRVO21, dart + SRVO301, SRVO41);
		_5othr( 1, 2 );
	}else if( t < 9* staytime + 5* movetime + 3* pul1time + 3* puttime + adds){
		_5move(SRVO11, SRVO21, dart + SRVO301, SRVO41, 420, 200, dart + SRVO301, SRVO41, t-(9* staytime + 5* movetime + 3* pul1time + 3* puttime + adds));
		_5othr( 0, 2 );
	}else if( t < 10* staytime + 5* movetime + 3* pul1time + 3* puttime + adds){
		_5srvo(420, 200, dart + SRVO301, SRVO41);
		_5othr( 0, 2 );
	}else if( t < 10* staytime + 5* movetime + 3* pul1time + 9* puttime + 2* adds){
		_5srvo(420, 200, dart + SRVO301, SRVO41);
		_5othr( 2, 2 );
	}else if( t < 11* staytime + 5* movetime + 3* pul1time + 9* puttime + 2* adds){
		_5srvo(SRVO11, SRVO21, dart + SRVO301, SRVO41);
		_5othr( 0, 0 );
	}else{
...
void _5put1(void){		
	...
	if(t > 0 && t < t_stay){
		_5srvo(SRVO11,SRVO21,SRVO33+ SRVO302,SRVO41);
		_5othr(0,0);
	}else if ( t < t_stay + t_move){
		_5move(SRVO11,SRVO21,SRVO33+ SRVO302, SRVO41, SRVO11, SRVO21,SRVO33+ SRVO302,SRVO42, t1 + t_stay);
	}else if ( t < t_stay + 2 * t_move){
		_5move(SRVO11,SRVO21,SRVO33+ SRVO302, SRVO42, SRVO11, SRVO21,SRVO33,SRVO42, t1 + t_stay + t_move);
...
//	goal = 2500 ;
//	goal = 3500 ;
	if( (result > 1000)&(result < 4000) ){goal = result ;}
	// 1) 射击电机输出窗口（低内存/低计算）
	if (t < 6000) {
