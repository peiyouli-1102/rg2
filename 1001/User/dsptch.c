...
void _5get(void){
	uint32_t t;
	uint32_t pul1time = (get_stat == 1 )?7000:2000, puttime = 400, movetime = 500, staytime = 1000, adds = 1000;
	...
	if( t < staytime ){
		...
		_5othr( 0, 0 );
	}else if( t < 3* staytime + movetime + pul1time-2000){
		_5srvo(SRVO12, SRVO22, dart, SRVO41);
		_5othr( 1, 0 );
	}else if( t < 4* staytime + movetime + pul1time-2000){
		_5srvo(SRVO12 + shk, SRVO22, dart, SRVO41);
		_5othr( 0, 0 );
	}else if( (t < 4* staytime + movetime + pul1time) & (t > 4* staytime + movetime + pul1time-2000) ){
		_5srvo(SRVO12 + shk, SRVO22, dart, SRVO41);
		_5othr( 1, 0 );
		...
		_5srvo(SRVO12, SRVO22, dart, SRVO41);
		_5othr( 2, 1 );
	}else if( t < 6* staytime + movetime + 3* pul1time + adds){
		_5srvo(SRVO12, SRVO22, dart, SRVO41);
		_5othr( 0, 1 );
	}else if( t < 6* staytime + 2* movetime + 3* pul1time + adds){
		_5move(SRVO12, SRVO22, dart, SRVO41, SRVO13, SRVO23, dart, SRVO41, t-(6* staytime + movetime + 3* pul1time + adds));
		_5othr( 0, 1 );
	...
	}else if( t < 8* staytime + 3* movetime + 3* pul1time + adds){
		...
		_5srvo(SRVO11, SRVO21 + shk, dart, SRVO41);
		_5othr( 1, 1 );
	}else if( t < 9* staytime + 3* movetime + 3* pul1time + puttime + adds){
		_5srvo(SRVO11, SRVO21, dart, SRVO41);
		_5othr( 0, 1 );
	}else if( t < 9* staytime + 4* movetime + 3* pul1time + puttime + adds){
		_5move(SRVO11, SRVO21, dart, SRVO41, SRVO11, SRVO21, dart + SRVO301, SRVO41, t-(9* staytime + 3* movetime + 3* pul1time + puttime));
		_5othr( 0, 1 );
	}else if( t < 10* staytime + 4* movetime + 3* pul1time + puttime + adds){
		_5srvo(SRVO11, SRVO21, dart + SRVO301, SRVO41);
		_5othr( 0, 1 );
	}else if( t < 11* staytime + 4* movetime + 3* pul1time + puttime + adds){
		_5srvo(SRVO11, SRVO21, dart + SRVO301, SRVO41);
		_5othr( 0, 2 );
	}else if( t < 11* staytime + 4* movetime + 3* pul1time + 3* puttime + 2* adds){
		_5srvo(SRVO11, SRVO21, dart + SRVO301, SRVO41);
		_5othr( 2, 2 );
	}else if( t < 12* staytime + 4* movetime + 3* pul1time + 3* puttime + 2* adds){
		_5srvo(SRVO11, SRVO21, dart + SRVO301, SRVO41);
		_5othr( 0, 0 );
	}else{
