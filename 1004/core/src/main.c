...
void Init_all(void){
    ...
    pid_angle_init();
	  ...
	  __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_1, 555);
	  __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_2, 358);
	  __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_3, 1160);
	  __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_4, 570);		//570
    
	  __HAL_TIM_SET_COMPARE(&htim3, TIM_CHANNEL_1, 500);
	  __HAL_TIM_SET_COMPARE(&htim3, TIM_CHANNEL_2, 500);
	  __HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_1, 0);

	  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_0 , GPIO_PIN_RESET);	//线盘
	  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_1 , GPIO_PIN_RESET);
	  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_2 , GPIO_PIN_RESET);	//电磁铁
