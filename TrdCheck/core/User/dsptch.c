...
void Init_schdl(void) {
	...
	Time.tasks[5] = (struct Task){_5rtn, "return", 1, Time.ms};   	// 时间片5: 舵机控制
...
void _5get__3(void){
	uint32_t t;
	uint32_t pul1time = (get_stat == 1 )?13000:3000, puttime = 1200, movetime = 500, staytime = 1000;
	// 13800
	// 预计算相对时间，避免重复计算
    ...
    // 使用更高效的条件判断和预计算
	if( t < staytime ){
		_5srvo(490, 545, dart, 570);
	}else if( t < staytime + movetime){
		_5move(490, 545, dart, 570, 675, 280, dart, 570, t-staytime);
	}else if( t < 2* staytime + movetime){
		_5srvo(b + 675, a, dart, 570);
	}else if( t < 2* staytime + movetime + pul1time-9000){
		_5srvo(b + 675, a, dart, 570);
		_5othr( 1, 0 );
	}else if( t < 3* staytime + movetime + pul1time-9000){
		_5srvo(675, a, dart, 570);
		_5othr( 0, 0 );
	}else if( t < 3* staytime + movetime + pul1time+1000){
		_5srvo(675, a, dart, 570);
		_5othr( 1, 0 );
	}else if( t < 4* staytime + movetime + pul1time+1000){
		_5srvo(675, a, dart, 570);
		_5othr( 0, 1 );
		...
		_5srvo(675, a, dart, 640);
		_5othr( 0, 1 );
	}else if( t < 5* staytime + 2* movetime + 2* pul1time){
		_5move(675, 280, dart, 640, e+70, f-70, dart, 640, t-(5* staytime + movetime + 2* pul1time));
		_5othr( 0, 1 );
	}else if( t < 5* staytime + 3* movetime + 2* pul1time){
		_5move(e+70, f-70, dart, 640, e, f, dart, 640, t-(5* staytime + 2* movetime + 2* pul1time));
		_5othr( 0, 1 );
		...
		Time.tasks[4] = (struct Task){_4stp, "stop", 1, Time.ms};
		result = 0 ;
	}else if( t < 7* staytime + 3* movetime + 2* pul1time + puttime - 400 ){
		_5srvo(e, f, dart, 640);
		_5othr( 1, 1 );
	}else if( t < 8* staytime + 3* movetime + 2* pul1time + puttime - 400 ){
		_5srvo(e, f, dart, 640);
		_5othr( 0, 1 );
	}else if( t < 8* staytime + 4* movetime + 2* pul1time + puttime - 400 ){
		_5move(e, f, dart, 640, e, f, dart, 620, t-(8* staytime + 4* movetime + 2* pul1time + puttime - 600));
		_5othr( 0, 1 );
		...
		_5srvo(e, f, dart, 640);
		_5othr( 0, 0 );
	}else if( t < 9* staytime + 4* movetime + 2* pul1time + 2* puttime + 1000){
		_5srvo(e, f, dart, 640);
		_5othr( 2, 0 );
	}else if( t < 10* staytime + 4* movetime + 2* pul1time + 2* puttime + 1000){
		_5srvo(e, f, dart, 570);
		_5othr( 0, 0 );
	}else{
...
void _5get(void){
	uint32_t t;
	uint32_t pul1time = (get_stat == 1 )?14000:3000, pul2time = pul1time - 4000 , puttime = 500, movetime = 500, staytime = 1000;
	// 13000 : 13800 : 14000 : 14200
	//1200
	// 预计算相对时间，避免重复计算
	if (Time.ms < Time.tasks[5].tim){
		return ;
	...
	if( t < staytime ){
		...
		_5srvo(675, a, dart, 570);
		_5othr( 0, 0 );
	}else if( t < 3* staytime + movetime + pul1time-3000){
		_5srvo(675, a, dart, 570);
		_5othr( 1, 0 );
		...
		_5srvo(b +675, a, dart, 570);
		_5othr( 1, 0 );
	}else if( t < 5* staytime + movetime + pul1time){
		_5srvo(675, a, dart, 570);
		_5othr( 0, 1 );
	}else if( t < 5* staytime + movetime + pul1time + pul2time){
		_5srvo(675, a, dart, 570);
		_5othr( 2, 1 );
	}else if( t < 6* staytime + movetime + pul1time + pul2time){
		_5srvo(675, a, dart, 570);
		_5othr( 0, 1 );
	}else if( t < 6* staytime + 2* movetime + pul1time + pul2time){
		_5move(675, 280, dart, 570, 510, 420, dart, 570, t-(6* staytime + movetime + pul1time + pul2time));
		_5othr( 0, 1 );
	}else if( t < 6* staytime + 3* movetime + pul1time + pul2time){
		_5move(510, 420, dart, 570, 475, 555, dart, 570, t-(6* staytime + 2* movetime + pul1time + pul2time));
		_5othr( 0, 1 );
	}else if( t < 7* staytime + 3* movetime + pul1time + pul2time){
		_5srvo(475, 555, dart, 570);
		_5othr( 0, 1 );
		if(get_stat == 1){
			Time.tasks[4] = (struct Task){_4fwd, "forward", 1, Time.ms};
			result = 0 ;
	...
	}else if( t < 8* staytime + 3* movetime + pul1time + pul2time){
		_5srvo(475, b + 555, dart, 570);
		_5othr( 1, 1 );
		Time.tasks[4] = (struct Task){_4stp, "stop", 1, Time.ms};
		result = 0 ;
	}else if( t < 8* staytime + 3* movetime + pul1time + pul2time + puttime){
		_5srvo(475, b + 555, dart, 570);
		_5othr( 1, 1 );
	}else if( t < 9* staytime + 3* movetime + pul1time + pul2time + puttime){
		_5srvo(475, 555, dart, 570);
		_5othr( 0, 1 );
	}else if( t < 9* staytime + 4* movetime + pul1time + pul2time + puttime){
		_5move(475, 555, dart, 570, 475, 555, dart + 170, 570, t-(8* staytime + 4* movetime + 2* pul1time + puttime - 600));
		_5othr( 0, 1 );
	}else if( t < 10* staytime + 4* movetime + pul1time + pul2time + puttime){
		_5srvo(475, 555, 170 + dart, 570);
		_5othr( 0, 1 );
	}else if( t < 11* staytime + 4* movetime + pul1time + pul2time + puttime){
		_5srvo(475, 555, 170 + dart, 570);
		_5othr( 0, 0 );
	}else if( t < 12* staytime + 4* movetime + pul1time + pul2time + 2* puttime + 1000){
		_5srvo(475, 555, 170 + dart, 570);
		_5othr( 2, 0 );
	}else if( t < 13* staytime + 4* movetime + pul1time + pul2time + 2* puttime + 1000){
		_5srvo(475, 555, 170 + dart, 570);
		_5othr( 0, 0 );
	}else{
		Time.tasks[5] = (struct Task){_5rtn, "return", 1, Time.ms};
...
void _5put1(void){		//500
	...
	if(t > 0 && t < t_stay){
		_5srvo(490,545,1455,570);
		_5othr(0,0);
	}else if ( t < t_stay + t_move){
		_5move(490,545,1455,570,  490,545,1455,780, t1 + t_stay);
	}else if ( t < t_stay + 2 * t_move){
		_5move(490,545,1455,780,  490,545,1300,780, t1 + t_stay + t_move);
	}else{
...
void _5put2(void){
	...
	uint32_t t_stay = 2000 , t_move = 500;
	if(t > 0 && t < t_stay){
		_5srvo(490,545,1300,777);
		_5othr(0,0);
	}else if ( t < t_stay + t_move){
		_5move(490,545,1300,777,  490,545,840,777, t-t_stay);
	}else{
		if((Time.tasks[4].task_name[1] == 't') ){
...
void _5put3(void){
	...
	uint32_t t_stay = 2000 , t_move = 500;
	if(t > 0 && t < t_stay){
		_5srvo(490,545,840,777);
	}else if ( t < t_stay + t_move){
		_5move(490,545,840,777,  490,545,380,777, t-t_stay-t_move);
	}else if ( t < 2*t_stay + t_move){
		_5srvo(490,545,380,777);
	}else{
		if((Time.tasks[4].task_name[1] == 't') ){
...
void _5rtn(void){
	...
	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_3, 1455);		//500
	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_4, 570);		//800
//	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_1, 475);
//	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_2, 555);
//	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_3, 380);		//500
//	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_4, 780);		//800
}
...
void _5rtn2(void){
	...
	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_3, 425);		//500
	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_4, 570);		//800
}
...
void _5sty1(void){
	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_1, 490);
	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_2, 545);
	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_3, 1300);
...
void _5sty2(void){
	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_1, 490);
	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_2, 545);
	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_3, 840);
	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_4, 777);
}
//780 840 380
void _5sty3(void){
	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_1, 490);
	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_2, 545);
	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_3, 380);
	__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_4, 777);
}
...
//	goal = 3500 ;
	...
	uint8_t in_b = (!in_a) && (t >= 4230) && (t < 7200);
	if (in_a) {
...
void _7shoot(void){
	...
	if(t < t_stop){
		...
		if(t >= node7 && t < node7 + 500){
			Time.tasks[5] = (struct Task){_5sty3, "stay", 1, Time.ms};
		}
	}else{
		printf("shootdon\r\n");
		dart_num = 0 ;
